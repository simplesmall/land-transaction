<template>
  <div>
    ...
    <div class="switchWrapper">
      <input type="checkbox" id="switchBtn" name="switch" style="width:80px;display: none">
      <label for="switchBtn" class="btn-switch" style="display: inline-block;width: 80px;height: 30px;">
...
<style scoped>
  ...
  #switchBtn:checked + label.btn-switch .circle{
    left: 50px;
  }
  #switchBtn:checked + label.btn-switch .on{display: inline-block;}
  #switchBtn:checked + label.btn-switch .off{display: none}
  #switchBtn:checked + label.btn-switch{
